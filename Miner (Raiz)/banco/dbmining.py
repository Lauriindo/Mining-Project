...
db = create_engine("mysql+pymysql://root:root@127.0.0.1:3306/mineradora")#Aqui eu passo os parametros de conexão com o banco de dados, como Usuario:senha:ip do banco:nome
...
class Maquinas(base):
    ...
    def __init__(self, nome, custo, kg): #Aqui eu crio o construtor da classe
...
class Clientes(base):
    ...
    def __init__(self, nome, cpf_cnpj, nome_fantasia): #Aqui eu crio o construtor da classe
